...
public class AFD {
	...
	public boolean Verifica(String palavra,String caminho) {

		Leitura anaLe = new Leitura(caminho);
		...
		if (aux) {
			System.out.printf("\nA palavra '%s' eh aceita pelo automato!\n", palavra);
		} else {
			System.out.printf("\nA palavra '%s' nao eh aceita pelo automato!\n", palavra);
		}
                return aux;
	}
	...
	public boolean VerificaPalavra(String palavra, No[] vetorNos, ArrayList<String> alfabeto, No noInicial) {
		...
		System.out.println("NÃO EH PALAVRA VAZIA!");
		...
		System.out.println("\nINICIANDO VERIFICAÇAO DE PALAVRA");
